...
# %%
# fig,ax=plt.subplots()
# ax.plot(ctffind4.iloc[:,0],ctffind4_defocus,label='ctffind4')
# ax.plot(ctffind5.iloc[:,0],ctffind5_defocus,label='ctffind5')
# ax.legend()
# fig.savefig("defocuscompare.png")
# # %%
# fig,ax=plt.subplots()
# ax.plot(ctffind4.iloc[:,0],ctffind4_score,label='ctffind4')
# ax.plot(ctffind5.iloc[:,0],ctffind5_score,label='ctffind5')
# ax.legend()
# fig.savefig("score_compare.png")
# # %%
# fig,ax=plt.subplots()
# ax.plot(ctffind4.iloc[:,0],ctffind4_fitreso,label='ctffind4')
# ax.plot(ctffind5.iloc[:,0],ctffind5_fitreso,label='ctffind5')
# ax.legend()
# fig.savefig("fitreso_compare.png")
# %%
# %% module loading
import numpy as np
import matplotlib.pyplot as plt
...
with lp.figure(f"ctftilt_lamella2_JE_cppresult_withdefocus",tight_layout=False):
    ...
    # ax_defocus.plot(rawtlt,ctffind5_fitreso,marker='o',facecolors='none',edgecolor='g',)
